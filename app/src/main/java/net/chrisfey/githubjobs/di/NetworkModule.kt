...
open class NetworkModule {
    ...
    @Provides
    fun githubJobRepository(githubJobClient: GithubJobHttpClient): GithubJobRepository =
        GithubJobRepository(githubJobClient)

    @Provides
    fun stackOverflowJobRepository(rssClient: StackOverflowRssFeedJobHttpClient, scrapeClient : StackOverflowScreenScrapeJobHttpClient): StackOverflowJobRepository =
